	...
	<header>
		...
		<div class="containerScroll">
			<section style="background-color: black; color: white;">
				<div class="containerScroll-text">
					<h1>Il y'en a qui regardent et Il y'en a qui <span style="color: #b08c2a;">portent</span></h1>
				</div>
				<div class="containerScroll-img">
					<img src="./img/petit-blanc.jpg">
				</div>
			</section>
			<section>
				<div class="containerScroll-img">
					<img src="./img/petit-noir.jpg" alt="">
				</div>
				<div class="containerScroll-text">
			...
			<section>
				<div class="containerScroll-img">
					<img src="./img/grand-logo.jpg" alt="">
				</div>
				<div class="containerScroll-text">
    	...
    	<div class="diviser">
    		<a class="tShirtPub" href="men.html">
