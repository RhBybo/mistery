...
<body>
    <div class="human">
        ...
        <div class="mdp-oulie-part">
        <form action="mdp-oublie-func.php" class="form">
				<h3 class="form__title">Mot de passe oublié ?</h3>
                <p>Si oui, alors saisissez votre email</p>
                <?php 
                ...
                ?> 
				<input type="email" name="email" class="form__dm margin-top-5" placeholder="Email" required="required" autocomplete="off">
				<button type="submit" name="mdp-oublie-btn" class="form__dm__btn margin-top-5" id="connexion-btn-id">Entrer</button>
			</form>
        </div>
