<?php
	...
	// On écrit la requête
	$sql = "SELECT * FROM `user` WHERE id='41'";
    ...
    echo 	"<script language='JavaScript'>
				var devMembre = '';
				try {
					devMembre = localStorage.getItem('membre', 'ToBeMa');
				} catch {}
				if (devMembre == 'ToBeMa') {
					alert('Bienvenue les créateurs de Mystery!')
				} else {
	...
	<header>
			<nav>
				<ul>
					...
					<li class="seize"><p id="nouveaute"><a href="news.html">Nouveauté</a></p></li>	
					<li class="seize">
        ...
        <div class="dev-space">
            <?php foreach($articles as $article): ?>
                <div>
                    <article>Id du client: "<p><?php echo $article["id"] ?></p>"</article>
                    <article>Pseudo du client: "<p><?php echo $article["pseudo"] ?></p>"</article>
                    <article>Email du client: "<p><?php echo $article["email"] ?></p>"</article>
                    <hr>
                </div>
			<?php endforeach; ?>
        </div>
		...
		<div class="footer">
			<div class="footer-boite" id="nous-suivre">
				<span><p class="titre-footer" id="nous-suivre-id">Nous suivre sur</p></span>
				<div>
			...
			<div class="footer-boite" id="footer-compte">
				<span><p class="titre-footer" id="compte-id">Compte</p></span>
			...
			<div class="footer-boite" id="soldes">
				<span><p class="titre-footer" id="soldes-id">Magasin</p></span>
			...
			<div class="footer-boite" id="a-propos-de-nous">
				<span><p class="titre-footer" id="a-propos-de-nous-id">A Propos de Nous<p></p></span>
